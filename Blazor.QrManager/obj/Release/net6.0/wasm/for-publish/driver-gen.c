...
extern void *mono_aot_module_QRCoder_info;
extern void *mono_aot_module_Blazor_QrManager_info;
...
void register_aot_modules ()
{
	...
	mono_aot_register_module (mono_aot_module_QRCoder_info);
	mono_aot_register_module (mono_aot_module_Blazor_QrManager_info);
